    ...
    public partial class Conversión_de_Texto_a_Audio : Form
    {
        ...
        public Conversión_de_Texto_a_Audio(string usuario)
        {
            ...
            foreach (InstalledVoice voice in sintetizador.GetInstalledVoices())
            {
                ...
                cbSintetizador.Items.Add(voice.VoiceInfo.Name);
            }
            cbSintetizador.SelectedIndex = 0;
        ...
        {
            //Conversión_de_Texto_a_Audio CTAA = new Conversión_de_Texto_a_Audio();
            //CTAA.Show();
        }
        ...
        private void pbPlay_Click(object sender, EventArgs e)
        {
            ...
            double Volumen = sliderVolumen.Value;
            double Rate = sliderRate.Value;

            indice = cbSintetizador.SelectedIndex;
            String nombre = vocesInfo.ElementAt(indice).Name;
            sintetizador.SelectVoice(nombre);

            sintetizador.Volume = (int)Volumen;
            sintetizador.Rate = (int)Rate;
            sintetizador.Speak(tbIntroducirTexto.Text);
        }
