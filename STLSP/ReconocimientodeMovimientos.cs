...
namespace STLSP
{
    public partial class Reconocimiento_de_Movimientos : Form
    {
        string usu = string.Empty;
        public Reconocimiento_de_Movimientos(string usuario)
        {
        ...
        {
            //Reconocimiento_de_Movimientos RM = new Reconocimiento_de_Movimientos();
            //RM.Show();
        }
